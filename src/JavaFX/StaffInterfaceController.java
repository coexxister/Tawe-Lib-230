...
public class StaffInterfaceController extends SceneController implements Initializable {
	...
	/**
	 * Handles the action of clicking the button to logout of the staff interface or return to the staff interface from
	 * a subscene.
	 *
	...
	/**
	 * Initialises the label in the interface to display a message to the user based on the account currently
	 * logged in.
	 *
